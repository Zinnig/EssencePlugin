...
/**
 *  DIRECTLY COPIED FROM ESSENTIALS X: (https://github.com/EssentialsX/Essentials/blob/2.x/Essentials/src/com/earth2me/essentials/utils/EnumUtil.java)
 * */
...
public class EnumUtil {
         ...
         */
        private static <T extends Enum> T valueOf(Class<T> enumClass, String... names) {
